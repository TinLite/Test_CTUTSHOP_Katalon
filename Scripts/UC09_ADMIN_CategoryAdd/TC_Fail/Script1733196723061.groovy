...
WebUI.setText(findTestObject('Object Repository/UC09/Page_Add categogy  Django site admin/input_Name_name'), categoryName)

WebUI.setText(findTestObject('Object Repository/UC09/Page_Add categogy  Django site admin/input_Slug_slug'), categorySlug)

WebUI.click(findTestObject('Object Repository/UC09/Page_Add categogy  Django site admin/input_Slug__save'))

WebUI.verifyElementPresent(findTestObject('Object Repository/UC09/Page_Add categogy  Django site admin/p_alert'), 0)
